...
- Vlad Plus - rev 11, Solves heating problems
- JoJo - rev 12, fixes problems preventing GPS from capturing satellites consistently.
...
Find the Vlad Plus board project
https://github.com/frankcohen/ReflectionsOS/tree/main/Devices/VladPlus

## What went wrong in VladPlus

GPS module is inconsistent at capturing satellites.

## JoJo Requirements

Fix module and circuit path traces to solve antenna issues.
