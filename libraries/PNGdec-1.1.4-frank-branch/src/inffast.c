...
void ZLIB_INTERNAL inflate_fast(z_streamp strm, unsigned start) {
    ...
    z_const unsigned char FAR *in;      /* pngdec_local strm->next_in */
    z_const unsigned char FAR *last;    /* have enough input while in < last */
    unsigned char FAR *out;     /* pngdec_local strm->next_out */
    ...
    unsigned long hold;         /* pngdec_local strm->hold */
    unsigned bits;              /* pngdec_local strm->bits */
    code const FAR *lcode;      /* pngdec_local strm->lencode */
    code const FAR *dcode;      /* pngdec_local strm->distcode */
    ...
    /* copy state to pngdec_local variables */
