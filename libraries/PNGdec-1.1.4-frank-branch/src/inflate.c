...
/* function prototypes */
pngdec_local int inflateStateCheck OF((z_streamp strm));
pngdec_local void fixedtables(struct inflate_state FAR *state);
pngdec_local int updatewindow OF((z_streamp strm, const unsigned char FAR *end, unsigned copy));

#ifdef BUILDFIXED
void makefixed OF((void));
#endif
pngdec_local unsigned syncsearch OF((unsigned FAR *have, const unsigned char FAR *buf,
                              unsigned len));

pngdec_local int inflateStateCheck(z_streamp strm)
{
 ...
 */
pngdec_local int updatewindow(z_streamp strm, const Bytef *end, unsigned copy)
{
    struct inflate_state FAR *state;
    unsigned dist;
 ...
 */
pngdec_local unsigned syncsearch(unsigned FAR *have, const unsigned char FAR *buf, unsigned len)
{
    unsigned got;
    unsigned next;
