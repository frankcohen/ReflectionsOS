...
// For Maker Faire 2024 Demo

// Acceleration threshold for shaking
#define shakeThreshold 0.15

// Duration to check for shaking in milliseconds
#define shakeDuration 200
...
class Accelerometer
{
  ...
  private:
    ...
    // Last time shake was detected
    unsigned long lastShakeTime;  // For Maker Faire 2024 Demo
    unsigned long franktime;
