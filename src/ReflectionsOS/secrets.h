...
//#define SECRET_SSID F("frankcohen")
//#define SECRET_PASS F("thanksfrank")

#define SECRET_SSID F("FranksFree-passwordFrank123")
#define SECRET_PASS F("Frank123")

// Must be 8 characters or longer
#define CALLIOPE_WIFI_PASS F("mystinker")

#define cloudCityURL F("https://cloudcity.starlingwatch.com/")
#define cloudCityHostURL F("cloudcity.starlingwatch.com")
